            ...
            <div className="flex items-start mb-6">
              ...
              <div className="flex-1">
                ...
                <div className="bg-purple-50 rounded-lg p-4 border border-purple-100">
                  <h4 className="font-bold text-gray-900 mb-2">Permitted Use:</h4>
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                ...
                <p className="text-purple-100 text-sm">legal@xash.co.zw</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                <h3 className="font-bold mb-3">Response Time</h3>
                <p className="text-purple-100 text-sm">Within 5 business days</p>
              </div>
            </div>
