...
const MapSection = () => {
  ...
  useEffect(() => {
    ...
    const customIcon = L.divIcon({
      html: `
        <div class="relative">
          <div class="w-12 h-12 bg-purple-600 rounded-full border-4 border-white shadow-xl animate-pulse flex items-center justify-center">
          ...
          <div class="absolute -bottom-10 left-1/2 transform -translate-x-1/2 bg-white px-3 py-2 rounded-lg shadow-lg whitespace-nowrap">
            <span class="text-sm font-bold text-purple-700">Xash Technologies</span>
          </div>
        </div>
      `,
    ...
    markerRef.current = L.marker([coordinates.lat, coordinates.lng], { icon: customIcon })
      ...
      .bindPopup(`
        <div class="p-2">
          <strong class="text-purple-700">Xash Technologies</strong><br>
    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                <div className="flex items-center">
                  <Compass className="text-purple-600 mr-2" size={18} />
          ...
          >
            {/* Loading overlay */}
            <div className="absolute inset-0 bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center z-0">
          ...
          <div className="bg-gradient-to-r from-purple-50 to-blue-50 p-6 border-t">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <div className="flex items-center">
                ...
                <div>
                  <h3 className="font-bold text-gray-900">Xash Technologies</h3>
              ...
              <button
                ...
                className="flex items-center bg-gradient-to-r from-purple-600 to-purple-700 text-white px-6 py-3 rounded-lg font-medium hover:from-purple-700 hover:to-purple-800 transition-all shadow-lg hover:shadow-xl"
              >
        ...
        >
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
            ...
            <p className="text-gray-600 text-sm">
              Exact coordinates: <code className="text-xs">-18.97244, 32.66996</code>
            </p>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-12 bg-gradient-to-br from-purple-600 to-purple-800 rounded-2xl p-8 text-white"
        >
          <div className="flex flex-col lg:flex-row items-center justify-between">
            ...
            <div className="bg-white/10 p-4 rounded-xl">
              <p className="text-sm text-purple-100 mb-2">GPS Coordinates for Navigation:</p>
